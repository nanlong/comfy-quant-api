use crate::{
    node_core::{
        ...
        NodeSymbolPrice, Port, SpotClientService, SpotStats, SpotTradeable, SymbolPriceStore,
    },
...
pub(crate) struct RuntimeStore {
    ...
    price_store: Arc<RwLock<SymbolPriceStore>>,
    stats: SpotStats,
    grid: Option<Grid>,
    initialized: bool,
}
...
impl RuntimeStore {
    fn new() -> Self {
        Self {
            price_store: Arc::new(RwLock::new(SymbolPriceStore::new())),
            stats: SpotStats::new(),
            grid: None,
            initialized: false,
        }
